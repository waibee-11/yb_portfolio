...
export default function WeatherApp(){
    ...
    return (
        <div className="px-10 pt-10 text-white md:w-2/4">
            ...
            <div className="font-bold text-red-600 bg-white rounded-full px-5 py-2 text-center mb-5">
            ...
            <button className="font-bold text-white bg-primary rounded-full px-5 py-2 text-center mb-5 mt-12 hover:bg-secondary transition ease-in-out">
